<template>
    <ion-page>
      ...
      <ion-tabs>
        ...
        <ion-tab-bar slot="bottom">
          ...
          <ion-tab-button tab="history" href="/history" selected>
            <ion-icon :icon="timeOutline"></ion-icon>
            <ion-label>Verlauf</ion-label>
          </ion-tab-button>
          <ion-tab-button tab="add" href="/add-workout">
          ...
          <ion-tab-button tab="measure" href="/measure">
            <ion-icon :icon="scaleOutline"></ion-icon>
            <ion-label>Messen</ion-label>
          </ion-tab-button>
        </ion-tab-bar>
      </ion-tabs>
    </ion-page>
  ...
  import { 
    ...
    IonTabButton,
    IonLabel,
    IonRouterOutlet // Import IonRouterOutlet
  } from '@ionic/vue';
  import { 
    timeOutline, 
    barbellOutline, 
  ...
  export default defineComponent({
    ...
    components: {
      ...
      IonTabButton,
      IonLabel,
      IonRouterOutlet // Add IonRouterOutlet to components
    },
    setup() {
